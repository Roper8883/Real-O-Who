import { getRequiredDocuments } from "./rules/engine.js";
...
function inspectionSlots(listingId, starts) {
...
const baseListings = [
    {
        ...
        description: "A polished Paddington terrace designed for modern family life, with calm natural light, flexible living, and a courtyard built for year-round entertaining.",
        ownerLoves: [
    ...
    },
    {
        ...
        heroMedia: [
            ...
            },
            {
                ...
                thumbnailUrl: "https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&w=1200&q=80",
                altText: "Video walkthrough thumbnail"
            }
        ],
        description: "A refined South Yarra apartment with generous indoor-outdoor living, a genuine study zone, and direct access to transport, dining, and river trails.",
    ...
    },
    {
        ...
        description: "Classic Queensland character, a family pool, and flexible living zones come together in a polished Bardon home close to schools and city access.",
...
export const listings = baseListings.map((listing) => ({
    ...listing,
